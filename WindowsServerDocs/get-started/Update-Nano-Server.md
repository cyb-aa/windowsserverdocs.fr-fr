...
Dans le cas le Cumulative mise à jour pour Windows Server 2016 : Le 26 septembre 2016 ([KB3192366](https://support.microsoft.com/en-us/kb/3192366)), vous devez tout d’abord installer la dernière Servicing Stack mise à jour pour Windows 10 Version 1607 : Le 23 août 2016 comme condition préalable ([KB3176936](https://support.microsoft.com/en-us/kb/3176936)). Pour la plupart des options ci-dessous, vous devez disposer des fichiers .msu contenant les packages de mise à jour .cab. Visitez le catalogue Microsoft Update pour télécharger chacun de ces packages de mise à jour :
...
## <a name="option-1-integrate-a-cumulative-update-into-a-new-image"></a>Option 1 : Intégrer une mise à jour cumulative dans une nouvelle image
...
## <a name="option-2-integrate-a-cumulative-update-into-an-existing-image"></a>Option 2 : Intégrer une mise à jour cumulative d’une image existante
...
## <a name="option-3-apply-the-cumulative-update-to-an-existing-offline-vhd-or-vhdx"></a>Option 3 : Appliquer la mise à jour cumulative à un existant hors connexion VHD ou VHDX
...
## <a name="option-4-apply-the-cumulative-update-to-a-running-nano-server"></a>Option 4 : Appliquer la mise à jour cumulative à un serveur Nano en cours d’exécution
...
## <a name="option-5-download-and-install-the-cumulative-update-to-a-running-nano-server"></a>Option 5 : Téléchargez et installez la mise à jour cumulative à un serveur Nano en cours d’exécution
...
- [Configuration de Windows Update pour WSUS](https://msdn.microsoft.com/en-us/library/dd939844(v=ws.10).aspx) en définissant les clés de Registre suivantes :
  ...
  - UseWUServer
  - AUOptions
- [La gestion des mises à jour de la structure dans VMM](https://technet.microsoft.com/library/gg675084(v=sc.12).aspx)
- [L’inscription d’une tâche planifiée](https://technet.microsoft.com/library/jj649811.aspx)
...
-   [Conteneurs Windows](https://msdn.microsoft.com/virtualization/windowscontainers/containers_welcome) :  la prise en charge des conteneurs Windows Server 2016 permet des améliorations de performances, une gestion réseau simplifiée et la prise en charge des conteneurs Windows sur Windows 10. Pour obtenir des informations supplémentaires sur les conteneurs, consultez [Containers: Docker, Windows and Trends](https://azure.microsoft.com/blog/2015/08/17/containers-docker-windows-and-trends/).  
...
## <a name="identity-and-access"></a>[Identité et accès](../identity/Identity-and-Access.md)  
...
##  <a name="administration"></a>[Administration](../administration/manage-windows-server.md)  
...
Pour plus d’informations sur le test des fonctionnalités DSC de Windows Management Framework 5, consultez la série de billets de blog mentionnés dans [Valider les fonctionnalités de PowerShell DSC](https://blogs.msdn.microsoft.com/powershell/2015/07/06/validate-features-of-powershell-dsc/). Pour effectuer le téléchargement, consultez [Windows Management Framework 5.1](https://docs.microsoft.com/powershell/scripting/wmf/setup/install-configure).
...
Pour plus d’informations, consultez [https://github.com/OneGet/oneget/wiki](https://github.com/OneGet/oneget/wiki).
...
## <a name="networking"></a>[Mise en réseau](../networking/Networking.md)  
...
## <a name="security-and-assurance"></a>[Sécurité et assurance](../security/Security-and-Assurance.md)  
...
## <a name="storage"></a>[Stockage](../storage/storage.md)

Dans Windows Server 2016, le stockage inclut des nouveautés et des améliorations pour le stockage par logiciel, ainsi que pour les serveurs de fichiers traditionnels. Voici quelques-unes des nouveautés. Pour d’autres améliorations et d’autres détails, consultez [What’s New in Storage in Windows Server 2016](../storage/whats-new-in-storage.md) (Nouveautés concernant le stockage dans Windows Server 2016).
...
## <a name="failover-clustering"></a>[Clustering de basculement](../failover-clustering/whats-new-in-failover-clustering.md)
...
- Possibilité d’exécuter et de gérer IIS 10.0 dans Nano Server. Consultez [IIS sur Nano Server](iis-on-nano-server.md).
...
Pour plus d’informations, consultez [IIS](https://iis.net/learn).

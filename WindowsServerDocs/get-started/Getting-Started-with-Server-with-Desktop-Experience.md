...
---------------------------------------
Si vous avez besoin d’une autre option d’installation, ou si vous avez terminé l’installation et que vous êtes prêt à déployer des charges de travail spécifiques, vous pouvez retourner à la [page principale de Windows Server 2016](Windows-Server-2016.md).
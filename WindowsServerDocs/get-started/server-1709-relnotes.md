...
[comment]: # (ID : inconnu ; Demandeur : stevenek ; état : déconnecté)  
...
Le canal semi-annuel de Windows Server se concentre sur les conteneurs et les scénarios d’application bénéficiant de l’innovation plus rapide, consultez ce [blog](https://cloudblogs.microsoft.com/windowsserver/2018/03/29/windows-server-semi-annual-channel-update) pour plus d’informations. Les clients qui souhaitent pour les rôles d’infrastructure, tels que des espaces de stockage Direct, doivent utiliser les versions de canal de maintenance à long terme, comme Windows Server 2016 (disponible dès maintenant) et [Windows Server 2019](https://cloudblogs.microsoft.com/windowsserver/2018/03/20/introducing-windows-server-2019-now-available-in-preview) (prochainement). Nous nous engageons à la création de la plateforme idéale pour l’infrastructure Hyper-convergée, et nous continuons à développer de nouvelles fonctionnalités et améliorer les existants en fonction de vos commentaires. 

Les espaces de stockage direct ont été introduits dans Windows Server 2016 et constituent la base de notre plateforme hyperconvergée. Nous avons été ravis par l’adoption positive de la plateforme hyperconvergée Microsoft et nous restons engagés auprès de nos clients.

Nous avez pris note de vos commentaires et que vous travaillez pour remettre le [ensemble suivant d’innovations](https://blogs.technet.microsoft.com/windowsserver/2017/09/07/sneak-peek-2-windows-server-version-1709-hyper-converged-infrastructure/) pour notre plateforme hyperconvergé. Ces fonctionnalités sont disponibles dès aujourd'hui dans [Windows Insiders](https://insider.windows.com/for-business/) les builds et nous aimerions vous permettant de les tester et partagez vos commentaires. Pour les clients recherchant une solution hyperconvergée validée, nous recommandons le programme [Windows Server Software Defined](http://microsoft.com/wssd).

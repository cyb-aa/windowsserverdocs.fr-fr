...
|-------------------|------------------|-----------------|  
|Service de rôle Dossiers de travail dans le Gestionnaire de serveur|Windows Server 2012 R2 ou Windows Server 2016|Les Services de fichiers et stockage permettent de configurer les partages de synchronisation (dossiers qui stockent des fichiers de travail de l’utilisateur), de surveiller Dossiers de travail et de gérer les partages de synchronisation et l’accès utilisateur|  
|Applets de commande Dossiers de travail|Windows Server 2012 R2 ou Windows Server 2016|Module Windows PowerShell qui contient des applets de commande complètes pour la gestion des serveurs Dossiers de travail|  

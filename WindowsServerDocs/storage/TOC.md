...
## [Espaces de nomsDFS](dfs-namespaces/dfs-overview.md)
### [Liste de vérification: Déployer des espaces de nomsDFS](dfs-namespaces/checklist-deploy-dfs-namespaces.md)
### [Liste de vérification: Régler un espace de nomDFS](dfs-namespaces/checklist-tune-a-dfs-namespace.md)
### [Déploiement d’espaces de nomsDFS](dfs-namespaces/deploying-dfs-namespaces.md)
#### [Choisir un type d’espace de noms](dfs-namespaces/choose-a-namespace-type.md)
#### [Créer un espace de nomsDFS](dfs-namespaces/create-a-dfs-namespace.md)
#### [Migrer un espace de noms basé sur un domaine vers le mode WindowsServer2008](dfs-namespaces/migrate-a-domain-based-namespace-to-windows-server-2008-mode.md)
#### [Ajouter des serveurs d’espaces de noms à un espace de nomsDFS basé sur un domaine](dfs-namespaces/add-namespace-servers-to-a-domain-based-DFS-namespace.md)
#### [Créer un dossier dans un espace de nomsDFS](dfs-namespaces/create-a-folder-in-a-dfs-namespace.md)
#### [Ajouter des cibles de dossier](dfs-namespaces/add-folder-targets.md)
#### [Répliquer des cibles de dossier à l’aide de la réplicationDFS](dfs-namespaces/replicate-folder-targets-using-dfs-replication.md)
#### [Déléguer les autorisations de gestion pour les espaces de nomsDFS](dfs-namespaces/delegate-management-permissions-for-dfs-namespaces.md)
### [Réglage des espaces de nomsDFS](dfs-namespaces/tuning-dfs-namespaces.md)
...
### [Vue d’ensemble du système de gestion de fichiers en réseau](nfs/nfs-overview.md)
### [Déployer le système de gestion de fichiers en réseau](nfs/deploy-nfs.md)
...
#### [Configurer des rapports de stockage](fsrm/configure-storage-reports.md)
#### [Configurez la vérification du filtrage de fichiers](fsrm/configure-file-screen-audit.md)
...
### [Réplication du stockage de serveur à serveur](storage-replica/server-to-server-storage-replication.md)
...
#### [Choisissez les lecteurs](storage-spaces/choosing-drives.md)
...
#### [Mettre à niveau un cluster direct d’espaces de stockage vers Windows Server2019](storage-spaces/upgrade-storage-spaces-direct-to-windows-server-2019.md)
### Gérer
...
##### [Disques durs virtuels](storage-spaces/performance-history-for-vhds.md)
##### [Ordinateurs virtuels](storage-spaces/performance-history-for-vms.md)
...
#### [Surveiller avec Azure Monitor](storage-spaces/configure-azure-monitor.md)
### Résoudre les problèmes
#### [Scénarios de résolution des problèmes](storage-spaces/troubleshooting-storage-spaces.md)
#### [États opérationnels et d'intégrité](storage-spaces/storage-spaces-states.md)
#### [Collecter des données](storage-spaces/data-collection.md)
...
### [Déploiement de Dossiers de travail avec ADFS et le proxy d'application web](work-folders/deploy-work-folders-adfs-overview.md)
...
#### [Étape5: configurer les clients](work-folders/deploy-work-folders-adfs-step5.md)

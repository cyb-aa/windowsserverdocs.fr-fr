...
### [Liste de vérification : déployer les espaces de noms DFS](dfs-namespaces/checklist-deploy-dfs-namespaces.md)
### [Liste de vérification : Optimiser un espace de noms DFS](dfs-namespaces/checklist-tune-a-dfs-namespace.md)

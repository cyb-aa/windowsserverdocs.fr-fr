...
**Ecrit** Les services ReFS sont écrits entrants de trois manières distinctes :
...
1.  **Écritures en miroir :**
    ...
    ![Écriture sur miroir](media/mirror-accelerated-parity/Write-to-Mirror.png)
...
2. **Écritures sur le miroir, réallouées à partir de la parité :**
    ...
    ![Réalloué-écriture](media/mirror-accelerated-parity/Reallocated-Write.png)
...
3. **Écrit dans la parité :**
    ...
    ![Écriture sur parité](media/mirror-accelerated-parity/Write-to-Parity.png)

**Mention** ReFS lira directement à partir du niveau contenant les données pertinentes. Si l’espace de parité comporte des HDD, le cache dans les espaces de stockage direct mettra en cache ces données afin d’accélérer les lectures ultérieures. 

...
## <a id="disk-not-initialized"></a> État d’un disque n’est pas initialisé ou le disque est manquant
...
**Solution :** réanalyser les disques ou redémarrez l’ordinateur pour voir si l’état du disque change. Essayez également les étapes de dépannage décrites dans [l’état d’un disque n’est pas initialisé ou le disque est manquant entièrement](#disk-not-initialized).
...
4. Essayez les étapes de dépannage décrites dans [l’état d’un disque n’est pas initialisé ou le disque est manquant entièrement](#disk-not-initialized).
...
- Essayez les étapes de dépannage décrites dans [l’état d’un disque n’est pas initialisé ou le disque est manquant entièrement](#disk-not-initialized).

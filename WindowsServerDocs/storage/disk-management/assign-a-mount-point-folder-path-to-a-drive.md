...
#### <a name="to-assign-a-mount-point-folder-path-to-a-drive-by-using-the-windows-interface"></a>Pour affecter un chemin d’accès du dossier de point de montage sur un lecteur à l’aide de l’interface Windows

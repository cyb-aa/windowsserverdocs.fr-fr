...
5. Pour activer vTPM à l’aide du protecteur de clé, exécutez la commande suivante. Pour &lt;ShieldedVMname @ no__t-1, utilisez le même nom de machine virtuelle que celui utilisé dans les étapes précédentes.

...
L’authentification NTLM est une famille de protocoles d’authentification inclus dans le Msv1\_0.dll Windows. Les protocoles d’authentification NTLM comprennent les versions 1 et 2 de LAN Manager et les versions 1 et 2 de NTLM . Les protocoles d’authentification NTLM authentifient les utilisateurs et les ordinateurs en fonction d’un mécanisme de stimulation @ no__t-0response qui prouve à un serveur ou un contrôleur de domaine qu’un utilisateur connaît le mot de passe associé à un compte. Lorsque vous faites appel au protocole NTLM, un serveur de ressources doit entreprendre l’une des actions suivantes afin de vérifier l’identité d’un ordinateur ou d’un utilisateur dès qu’un nouveau jeton d’accès est nécessaire :
...
L’authentification NTLM est toujours prise en charge et doit servir à des fins d’authentification Windows avec des systèmes configurés en tant que membres d’un groupe de travail. L’authentification NTLM est également utilisée pour l’authentification d’ouverture de session locale sur les contrôleurs non-no__t-0domain. L’authentification Kerberos version 5 est la méthode d’authentification par défaut pour les environnements Active Directory, mais une application non @ no__t-0Microsoft ou Microsoft peut toujours utiliser NTLM.
...
|**Planification**|[Guide de modélisation des menaces de l’infrastructure informatique](https://technet.microsoft.com/library/dd941826.aspx)<br /><br />[Threats et contre-mesures : Paramètres de sécurité dans Windows Server 2003 et Windows XP @ no__t-0<br /><br />[Guide des menaces et des contre-mesures : Paramètres de sécurité dans Windows Server 2008 et Windows Vista @ no__t-0<br /><br />[Guide des menaces et des contre-mesures : Paramètres de sécurité dans Windows Server 2008 R2 et Windows 7 @ no__t-0|
|**Déploiement**|[protection étendue de l'authentification](https://support.microsoft.com/kb/968389)<br /><br />[Guide d’utilisation de l’audit et de la restriction de l’utilisation de NTLM](https://technet.microsoft.com/library/jj865674(v=ws.10).aspx)<br /><br />@no__t 0Ask l’équipe des services d’annuaire : Blocage de NTLM et vous : Méthodologies d’analyse et d’audit des applications dans Windows 7 @ no__t-0<br /><br />[Blog sur l’authentification Windows](https://blogs.technet.com/authentication/)<br /><br />[Configuration de MaxConcurrentAPI pour l’authentification NTLM Pass @ no__t-1through](https://social.technet.microsoft.com/wiki/contents/articles/9759.configuring-maxconcurrentapi-for-ntlm-pass-through-authentication.aspx)|
|**Développement**|[@No__t Microsoft NTLM-1Windows @ no__t-2](https://msdn.microsoft.com/library/aa378749(VS.85).aspx)<br /><br />[ @ NO__T-1 MS @ NO__T-2NLMP @ NO__T-3 : NT LAN Manager \(NTLM @ no__t-1 spécification du protocole d’authentification @ no__t-2<br /><br />[ @ NO__T-1 MS @ NO__T-2NNTP @ NO__T-3 : NT LAN Manager \(NTLM @ no__t-1 authentification : Network News Transfer Protocol \(NNTP @ no__t-1 extension @ no__t-2<br /><br />[ @ NO__T-1 MS @ NO__T-2NTHT @ NO__T-3 : Spécification de protocole NTLM sur HTTP @ no__t-0|
|**Résolution des problèmes**|Pas encore disponible|
|**Ressources de la communauté**|[Is ce cheval mort encore : Goulots d’étranglement NTLM et le runtime RPC @ no__t-0|

...
|Fournisseur de support de sécurité TLS\/SSL et DTLS \(Schannel\)|[Vue d’ensemble &#40;du SSP&#41; TLS-SSL Schannel](../tls/tls-ssl-schannel-ssp-overview.md)<br /><br />[Informations techniques de référence sur le fournisseur SSP (Security Support Provider) Schannel](../tls/schannel-security-support-provider-technical-reference.md)|

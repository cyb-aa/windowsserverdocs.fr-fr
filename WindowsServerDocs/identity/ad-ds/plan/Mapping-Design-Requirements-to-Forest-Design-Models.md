...
|Scénario|Connectivité limitée|l’isolation des données.|Autonomie des données|Isolation du service|Autonomie des services|
|------------|------------------------|------------------|-----------------|---------------------|--------------------|
...
|[Scénario 4 : utiliser une forêt d’organisation ou une forêt à accès restreint pour l’isolation des données](#BKMK_4)|N/A|Oui|NON APPLICABLE|NON APPLICABLE|NON APPLICABLE|

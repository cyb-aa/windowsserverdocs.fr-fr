...
## <a name="BKMK_1.1"></a>Configurer les composants requis et l’environnement de test  
La configuration de test implique la configuration de deux forêts : Adatum Corporation et contoso, Ltd et disposant d’une relation d’approbation bidirectionnelle entre contoso et adatum. « adatum.com » est la forêt approuvée et « contoso.com » est la forêt d’approbation.  
...
Vous devez configurer les éléments suivants pour le laboratoire. Ces procédures sont expliquées en détail dans [Appendix B : configuration de l’environnement de test](Appendix-B--Setting-Up-the-Test-Environment.md)  
...
|Revendications de l’utilisateur sur Adatum et contoso|ID : ad://ext/Company :ContosoAdatum,<br /><br />Attribut source : société<br /><br />Valeurs suggérées : Contoso, la adatum **importante :** Vous devez définir l’ID du type de revendication « Company » sur Contoso et adatum pour que la transformation des revendications fonctionne.|  
...
## <a name="BKMK_3"></a>Configurer une transformation de revendications sur une forêt approuvée (adatum)  
...
### <a name="BKMK_2.3"></a>Définir un lien de transformation des revendications sur l’objet domaine d’approbation de adatum  
...
## <a name="BKMK_4"></a>Configurer la transformation de revendications dans la forêt d’approbation (contoso)  
...
### <a name="BKMK_4.1"></a>Créer une stratégie de transformation des revendications dans contoso  
...
### <a name="BKMK_4.2"></a>Définir un lien de transformation des revendications sur l’objet domaine d’approbation de contoso  
...
2. Accédez au dossier \\ \ fichier1. contoso. com\Earnings.  

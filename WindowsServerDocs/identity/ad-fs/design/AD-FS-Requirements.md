...
> [!CAUTION]  
> Les certificats utilisés pour la signature des jetons\-la signature et le chiffrement des\-\/le chiffrement sont essentiels à la stabilité du service FS (Federation Service). Les clients qui gèrent leur propre jeton\-la signature de & de jeton\-le déchiffrement\/certificats de chiffrement doivent s’assurer que ces certificats sont sauvegardés et sont disponibles indépendamment pendant un événement de récupération.  
...
|Vitesse du processeur|processeur 1,4 GHz 64\-bits|Quad\-Core, 2 GHz|  
|RAM|512 Mo|4 Go|  
...
**Exigences de niveau de\-fonctionnel de domaine**  
...
|RsaOaepKeyWrap \- [http :\/\/www.w3.org\/2001\/04\/xmlenc\#rsa\-oaep\-mgf1p](http://www.w3.org/2001/04/xmlenc#rsa-oaep-mgf1p)|1024|valeur par défaut. Algorithme pris en charge pour le chiffrement de la clé symétrique qui chiffre le jeton de sécurité.|  

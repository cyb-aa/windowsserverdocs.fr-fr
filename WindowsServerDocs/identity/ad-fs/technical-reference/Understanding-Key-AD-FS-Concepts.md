...
|Approbation de fournisseur de revendications|Dans le composant logiciel enfichable de gestion de AD FS @ no__t-0in, les approbations de fournisseur de revendications sont des objets d’approbation généralement créés dans des organisations partenaires de ressources pour représenter l’organisation dans la relation d’approbation dont les comptes accèdent aux ressources du partenaire de ressource. dernière. Un objet d'approbation de fournisseur de revendications se compose d'un ensemble d'identificateurs, de noms et de règles qui identifient ce partenaire auprès du service de fédération local.|  
|Approbation de fournisseur de revendications local|Objet d’approbation qui représente AD LDS ou troisième répertoires LDAP @ no__t-0party LDAP @ no__t-1based dans une batterie de serveurs AD FS. Un objet d’approbation de fournisseur de revendications local se compose d’un ensemble d’identificateurs, de noms et de règles qui identifient ce répertoire LDAP @ no__t-0based sur le service FS (Federation Service) local.|  
|Métadonnées de fédération|Format de données utilisé pour la communication des informations de configuration entre un fournisseur de revendications et une partie de confiance pour faciliter la configuration des approbations de fournisseur de revendications et des approbations de partie de confiance. Le format de données est défini dans Security Assertion Markup Language \(SAML @ no__t-1 2,0 et il est étendu dans WS @ no__t-2Federation.|  

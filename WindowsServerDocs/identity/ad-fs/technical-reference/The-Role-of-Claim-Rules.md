...
-   Fournir des revendications riches et détaillées\-des fonctionnalités d’autorisation basées sur les administrateurs qui souhaitent autoriser ou refuser l’accès à des utilisateurs spécifiques

...
ms.locfileid: "67316344"
---
# <a name="ad-fs-operations"></a>Opérations d'AD FS



Ce document contient une liste de toutes les opérations de documentation pour AD FS pour Windows Server 2016. Cela inclut les éléments suivants :  
...
- [Paramètres d’authentification unique AD FS 2016](../ad-fs/operations/AD-FS-2016-Single-Sign-On-Settings.md)
...
- [Ajouter un attribut de Store](../ad-fs/operations/Add-an-Attribute-Store.md)
...
- [Configurer AD FS 2016 et Azure MFA](../ad-fs/operations/Configure-AD-FS-2016-and-Azure-MFA.md)
...
- [Configurer AD FS pour l’authentification de certificat utilisateur](../ad-fs/operations/Configure-User-Certificate-Authentication.md)
...
- [Personnaliser des en-têtes de réponse de sécurité HTTP avec AD FS 2019](../ad-fs/operations/customize-http-security-headers-ad-fs.md)
...
- [Gestion des certificats SSL dans AD FS et WAP 2016](../ad-fs/operations/Manage-SSL-Certificates-AD-FS-WAP-2016.md)
- [Configurer un environnement de laboratoire AD FS](../ad-fs/operations/Set-up-an-AD-FS-lab-environment.md)
- [SQL correctement de réglage et de latence d’adressage](../ad-fs/operations/adfs-sql-latency.md) 

...
-   À l’aide des paramètres de lot
    ...
    -   Le **pour** commande remplace **% *** Variable* ou **%% *** Variable* par chaque chaîne de texte dans le jeu spécifié jusqu'à ce que la commande spécifiée traite tous les fichiers.
...
-   Spécification d’un groupe de fichiers
    ...
    (ar??1991.* ap??1991.*)
    ```  
    Lorsque vous utilisez le **pour** commande, la première valeur dans *définir* remplace **% *** Variable* ou **%% *** Variable*et puis spécifié commande traite cette valeur. Ce processus se poursuit jusqu'à ce que tous les fichiers (ou les groupes de fichiers) qui correspondent à la *définir* valeur sont traités.

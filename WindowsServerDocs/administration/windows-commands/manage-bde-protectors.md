...
|   -désactiver    |                      Désactive la protection, ce qui permet à quiconque d’accéder aux données chiffrées en rendant la clé de chiffrement disponible non sécurisée sur le lecteur. Aucun protecteur de clé n’est supprimé. La protection sera reprise lors du démarrage suivant de Windows, sauf si les [paramètres](manage-bde-protectors.md#BKMK_disableprot) facultatifs sont utilisés pour spécifier le nombre de redémarrages.                       |
|    -activer    |                                                                                                                             Active la protection en supprimant la clé de chiffrement non sécurisée du lecteur. Tous les protecteurs de clé configurés sur le lecteur seront appliqués.                                                                                                                             |

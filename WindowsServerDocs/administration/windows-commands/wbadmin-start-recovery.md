...
description: Rubrique de référence pour Wbadmin start Recovery, qui exécute une opération de récupération basée sur les paramètres que vous spécifiez.
...
|-remplacer|Valide uniquement lors de la récupération de fichiers. Spécifie l’action à entreprendre lorsqu’un fichier récupéré existe déjà au même emplacement.</br>-   **Ignorer** provoque l’omission par sauvegarde Windows Server du fichier existant et poursuivre la récupération du fichier suivant.</br>-   **CreateCopy** provoque la création par sauvegarde Windows Server d’une copie du fichier existant afin que le fichier existant ne soit pas modifié.</br>-   Si le **remplacement est remplacé** , sauvegarde Windows Server remplace le fichier existant par le fichier de la sauvegarde.|
...
```
Pour exécuter une récupération de la sauvegarde à partir du 31 mars 2013, à 9:00 A.M., du volume \\ \\? \Volume{cc566d14-44A0-11d9-9d93-806e6f6e6963}\, , tapez :
```
wbadmin start recovery -version:03/31/2013-09:00 -itemType:Volume 
-items:\\?\Volume{cc566d14-44a0-11d9-9d93-806e6f6e6963}\
```
Pour exécuter une récupération de la sauvegarde à partir du 30 avril 2013, prise à 9:00 A.M., du dossier \\ \\partagé servername\share à partir de Serveur01, tapez :
```

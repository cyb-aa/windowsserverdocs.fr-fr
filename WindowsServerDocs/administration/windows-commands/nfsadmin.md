...
**\-u** *UserName*  
Spécifie le nom d’utilisateur de l’utilisateur dont informations d’identification doivent être utilisées. Il peut être nécessaire d’ajouter le nom de domaine pour le nom d’utilisateur sous la forme *domaine***\\***nom d’utilisateur*  

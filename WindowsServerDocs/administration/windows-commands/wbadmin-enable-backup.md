...
description: La rubrique de référence pour Wbadmin activer la sauvegarde, qui crée et active une planification de sauvegarde quotidienne, ou modifie une planification de sauvegarde existante.

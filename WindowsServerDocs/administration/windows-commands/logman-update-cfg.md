...
La commande suivante met à jour le collecteur de données de configuration existant cfg_log pour collecter la clé de registre HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\Currentverion @ no__t-0.  
```  

...
---
# <a name="manage-bde-wipefreespace"></a>Manage WipeFreeSpace
...
|---------|-----------|
|@no__t 0Drive >|Représente une lettre de lecteur suivie d’un signe deux-points, d’un chemin d’accès de GUID de volume ou d’un volume monté.|

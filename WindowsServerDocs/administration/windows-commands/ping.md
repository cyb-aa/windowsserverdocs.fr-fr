...
|nombre \<d'/n\>|Spécifie le nombre de messages de demande d’écho envoyés. Valeur par défaut : 4.|
|taille \<de/l\>|Spécifie la longueur, en octets, du champ de données dans les messages de demande d’écho envoyés. La valeur par défaut est 32. La taille maximale est de 65 527.|
...
Pour afficher la sortie de commande **ping** :

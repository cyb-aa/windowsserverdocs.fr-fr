...
ms.locfileid: "82724199"
---
# <a name="manage-bde-changekey"></a>Manage-bde : ChangeKey



Modifie la clé de démarrage pour un lecteur de système d’exploitation.
...
Pour illustrer l’utilisation de la commande **-ChangeKey** pour créer une nouvelle clé de démarrage sur le lecteur E à utiliser avec le chiffrement BitLocker sur le lecteur C.
```

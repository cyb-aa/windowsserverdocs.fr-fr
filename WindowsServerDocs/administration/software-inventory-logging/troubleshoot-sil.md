...
2. Exécutez **get-silvmhost**
   ...
   - Si les hôtes sont répertoriés en tant que **inconnu**, puis accédez à problème 2. 
   d - si les hôtes sont répertoriés, mais aucun **datetime** sous le **interrogation récente** colonne, puis accédez à **problème 2** ci-dessous.
...
3. Ouvrez **SSMS** et se connecter à la **moteur de base de données**.

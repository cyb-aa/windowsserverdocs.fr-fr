...
## <a name="starting-and-stopping-software-inventory-logging"></a><a name="BKMK_Step1"></a>Démarrage et arrêt de la journalisation de l’inventaire logiciel  
...
## <a name="software-inventory-logging-over-time"></a><a name="BKMK_Step2"></a>Journalisation de l’inventaire logiciel au fil du temps  
...
## <a name="displaying-software-inventory-logging-data"></a><a name="BKMK_Step3"></a>Affichage des données de journalisation de l’inventaire logiciel  
...
## <a name="deleting-data-logged-by-software-inventory-logging"></a><a name="BKMK_Step4"></a>Suppression des données consignées par la journalisation de l’inventaire logiciel  
...
## <a name="backing-up-and-restoring-data-logged-by-software-inventory-logging"></a><a name="BKMK_Step5"></a>Sauvegarde et restauration des données consignées par la journalisation de l’inventaire logiciel  
...
## <a name="reading-data-logged-and-published-by-software-inventory-logging"></a><a name="BKMK_Step6"></a>Lecture des données consignées et publiées par la journalisation de l’inventaire logiciel  
...
## <a name="software-inventory-logging-security"></a><a name="BKMK_Step7"></a>Sécurité de la journalisation de l’inventaire logiciel  
...
## <a name="working-with-date-and-time-settings-in-windows-server-2012-r2-software-inventory-logging"></a><a name="BKMK_Step8"></a>Utilisation des paramètres de date et d’heure dans la journalisation de l’inventaire logiciel de Windows Server 2012 R2  
...
## <a name="enabling-and-configuring-software-inventory-logging-in-a-mounted-virtual-hard-disk"></a><a name="BKMK_Step10"></a>Activation et configuration de la journalisation de l’inventaire logiciel dans un disque dur virtuel monté  
...
## <a name="overview-of-using-software-inventory-logging-in-windows-server-2012-r2-without-kb-3000850"></a><a name="BKMK_Step11"></a>Présentation de l’utilisation de la journalisation de l’inventaire logiciel dans Windows Server 2012 R2 sans KB 3000850  
...
## <a name="using-software-inventory-logging-in-a-windows-server-2012-r2-hyper-v-environment-without-kb-3000850"></a><a name="BKMK_Step12"></a>Utilisation de la journalisation de l’inventaire logiciel dans un environnement Hyper-V Windows Server 2012 R2 sans KB 3000850  

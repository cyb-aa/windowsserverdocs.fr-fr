...
|------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|    Outlook Web App     | -AD FS à l’aide de l’authentification non basée sur les revendications<br />-Direct<br />-AD FS à l’aide de l’authentification basée sur les revendications pour Exchange 2013 service Pak 1 (SP1) sur site |                                                                  Pour plus d’informations, voir : [À l’aide de l’authentification basée sur les revendications AD FS avec Outlook Web App et EAC](https://go.microsoft.com/fwlink/?LinkId=393723)                                                                  |
...
6.  Désactivez la propriété de cookie HttpOnly dans le proxy d’application Web sur l’application publiée RDG. Pour autoriser le contrôle ActiveX RDG à accéder au cookie d’authentification du proxy d’application Web, vous devez désactiver la propriété HttpOnly sur le cookie du proxy d’application Web.  
    ...
    Pour installer le correctif du proxy d' [application Web](https://support.microsoft.com/en-gb/kb/3000850) ou le [https://support.microsoft.com/en-gb/kb/3000850 ,](https://support.microsoft.com/en-gb/kb/3000850)vous devez disposer des éléments suivants.  

    Après l’installation du correctif logiciel, exécutez le script PowerShell suivant sur le serveur proxy d’application Web en spécifiant le nom d’application approprié :  
...
7.  Configurez la collection RDG appropriée sur le serveur de collecte pour permettre au client Connexion Bureau à distance (Mstsc. exe) de savoir que la pré-authentification est requise dans le fichier RDP.  
    ...
    -   Dans Windows Server 2008 R2 :  
        ...
        2.  Accédez à **démarrer** >**outils d’administration** > **services Terminal server** > **TS Gestionnaire RemoteApp.**  
        ...
        5.  Lorsque vous avez terminé, cliquez sur **appliquer**.  
            ...
            Pour plus d’informations sur le protocole RDP, consultez [configuration du scénario de mot de passe à usage unique de la passerelle TS](https://technet.microsoft.com/library/cc731249(v=ws.10).aspx).  

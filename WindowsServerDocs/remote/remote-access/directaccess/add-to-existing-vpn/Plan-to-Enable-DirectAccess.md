...
**Remarque :** Windows Server 2012 associe DirectAccess et le Service d’accès à distance (RAS) en un seul rôle accès à distance. Cette section décrit les étapes de planification qui sont nécessaires pour déployer un seul serveur d’accès à distance exécutant Windows Server 2016 avec les fonctionnalités de base. 

...
|Avertissement|La configuration pour le serveur [*nom du serveur*] n'a pas encore été récupérée auprès du contrôleur de domaine.|La configuration spécifiée dans l'objet de stratégie de groupe n'a pas encore atteint le serveur.<br /><br />Il peut falloir jusqu'à 10 minutes pour propager une nouvelle configuration.|Laissez plus de temps aux stratégies pour se mettre à jour sur le serveur.|  

...
Par exemple, si l’application Calculatrice est en cours d’exécution dans une [ID de session 1](https://docs.microsoft.com/previous-versions/iis/6.0-sdk/ms524326(v=vs.90)), vous voyez ```1:4232 <Calculator.exe>```.

...
## [Prendre en main](rds-get-started.md)
...
### [Configurations de la sécurité prises en charge pour l’infrastructureVDI de Windows10](rds-vdi-supported-config.md)
...
### [Office2016 dans les déploiements de services Bureau à distance et VDI](https://docs.microsoft.com/deployoffice/rds-office-vdi-rdsh)
...
#### [Rôles de Services Bureau à distance](rds-roles.md)
...
### [Migrer les déploiements des Services Bureau à distance vers WindowsServer2016](migrate-rds-role-services.md)
### [Migrer vos licences d’accès client aux services Bureau à distance](migrate-rds-cals.md)
### [Mettre à niveau les déploiements des services Bureau à distance vers Windows Server2016](upgrade-to-rds.md)
...
#### [Découvrez comment utiliser Multi-Factor Authentication avec les Services Bureau à distance](/azure/multi-factor-authentication/nps-extension-remote-desktop-gateway)
...
#### [Déployer un système de fichiers d'espaces de stockage direct à deuxnœuds pour le stockage UPD](rds-storage-spaces-direct-deployment.md)
...
#### [Configurer AzureSiteRecovery pour les Services Bureau à distance](rds-disaster-recovery-with-azure.md)
...
## [Exécuter et régler](rds-run-and-tune.md)
...
### [Optimisation de Windows10, version1803, pour un rôle Virtual Desktop Infrastructure (VDI)](rds-vdi-recommendations-1803.md)
### [Gérer les utilisateurs de votre collection Services Bureau à distance](rds-user-management.md)
### [Personnaliser le titre des Services Bureau à distance «ressources de travail» à l'aide de PowerShell sur WindowsServer](rds-work-resources.md)
...
#### [Paramètres de confidentialité pour les applications gérées et les bureaux](clients/remote-privacy-settings.md)
#### [Résolution des problèmes de connexions Bureau à distance](clients/troubleshoot-remote-desktop-connections.md)
### Client Bureau à distance pour Windows
#### [Commencer](clients/windows.md)
#### [Quelles sont les nouveautés du client Windows?](clients/windows-whatsnew.md)
### Client Bureau à distance pour Android
#### [Commencer](clients/remote-desktop-android.md)
#### [Quelles sont les nouveautés dans le client Android?](clients/android-whatsnew.md)
### Client Bureau à distance pour iOS
#### [Commencer](clients/remote-desktop-ios.md)
#### [Quelles sont les nouveautés dans le client iOS?](clients/ios-whatsnew.md)
### Client Bureau à distance pour Mac
#### [Commencer](clients/remote-desktop-mac.md)
#### [Quelles sont les nouveautés dans le client MacOS?](clients/mac-whatsnew.md)
### Client Bureau à distance par le web
...
### Configuration de votre PC de bureau à distance

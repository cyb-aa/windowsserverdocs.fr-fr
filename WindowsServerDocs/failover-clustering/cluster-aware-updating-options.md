...
|Option|Valeur par défaut|Détails|  
|------------|-------------------|-------------|  
|**ClusterName**|Aucune <br>**Remarque :**  Cette option ne doit être définie que lorsque l’interface utilisateur de la mise à jour adaptée aux clusters n’est pas exécutée sur un nœud de cluster de basculement ou si vous souhaitez référencer un cluster de basculement différent de celui où l’interface utilisateur de la mise à jour|Nom NetBIOS du cluster sur lequel effectuer l’exécution de mise à jour.|  

...
description: Comment faire pour activer Windows Server 2019
ms.custom: na
...
ms.locfileid: "9150869"
---
# Activation de Windows Server 2019

>S’applique à: Windows Server 2019, Windows Server 2016

Les informations suivantes exposent les considérations de planification initiales dont vous avez besoin pour passer en revue pour l’activation des Services de gestion des clés (KMS) impliquant Windows Server 2019. Pour plus d’informations sur les activations KMS impliquant des systèmes d’exploitation plus anciens que ceux répertoriés ici, voir [Étape 1: passer en revue et sélectionner les méthodes d’activation](https://technet.microsoft.com/library/jj134256(WS.11).aspx).
...
Les hôtes KMS n’ont pas besoin d’être des serveurs dédiés et le service KMS peut être co-hébergé avec d’autres services. Vous pouvez exécuter un hôte KMS sur n’importe quel système physique ou virtuel qui exécute Windows 10, Windows Server 2019, Windows Server 2016, Windows Server 2012 R2, Windows 8.1 ou Windows Server 2012.
...
Le tableau suivant résume les exigences de client et l’hôte KMS pour les réseaux qui incluent des clients Windows Server 2016, Windows Server 2019 et Windows 10.

>[!NOTE]
>- Mises à jour peuvent être requises sur le serveur KMS pour prendre en charge l’activation d’un de ces clients plus récents. Si vous recevez des erreurs d’activation, vérifiez que vous disposez des mises à jour appropriées répertoriées sous ce tableau.
>- Si vous travaillez avec des machines virtuelles, consultez [L’Activation automatique de Machine virtuelle](vm-activation-19.md) pour des informations et les clés AVMA.

|Groupe de clés de produit|Service KMS peut être hébergé sur|Éditions de Windows activées par cet hôte KMS|  
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|  
|Licence en volume pour Windows Server 2019|WindowsServer2012R2<br /><br />Windows Server2016<br /><br />Windows Server2019<br /><br />|Canal semi-annuel WindowsServer<br /><br />Windows Server 2019 (toutes éditions)<br /><br />WindowsServer2016 (toutes éditions)<br /><br />Windows 10 entreprise LTSC 2019 <br /><br />Windows 10 entreprise LTSC N 2019<br /><br />Windows10 LTSB (2015 et 2016)<br /><br />Windows10Professionnel<br /><br />Windows10 Entreprise<br /><br />Windows 10 Professionnel pour les stations de travail<br /><br />Windows10 Éducation<br /><br />WindowsServer2012R2 (toutes éditions)<br /><br />Windows8.1Professionnel<br /><br />Windows8.1Entreprise<br /><br />WindowsServer2012 (toutes éditions)<br /><br />Windows Server 2008 R2 (toutes éditions)<br /><br />Windows Server 2008 (toutes éditions)<br /><br />Windows7Professionnel<br /><br />Windows7Entreprise<br />| 
|Licence en volume pour WindowsServer2016|WindowsServer2012<br /><br />WindowsServer2012R2<br /><br />Windows Server2016<br /><br />|Canal semi-annuel WindowsServer <br><br>WindowsServer2016 (toutes éditions)<br /><br />Windows10 LTSB (2015 et 2016)<br /><br />Windows10Professionnel<br /><br />Windows10 Entreprise<br /><br />Windows 10 Professionnel pour les stations de travail<br><br>Windows10 Éducation<br><br>WindowsServer2012R2 (toutes éditions)<br /><br />Windows8.1Professionnel<br /><br />Windows8.1Entreprise<br /><br />WindowsServer2012 (toutes éditions)<br /><br />Windows Server 2008 R2 (toutes éditions)<br /><br />Windows Server 2008 (toutes éditions)<br /><br />Windows7Professionnel<br /><br />Windows7Entreprise<br /><br />| 
...
>- Les installations du service KMS sur Windows Server 2012 doivent être mises à jour pour prendre en charge l’activation des clients exécutant Windows 10 et Windows Server 2016 ou Windows Server 2019, ou de client plus récente ou de systèmes d’exploitation serveur. Pour plus d’informations, voir[juillet 2016 correctif cumulatif pour Windows Server 2012](https://support.microsoft.com/help/3172615/july-2016-update-rollup-for-windows-server-2012). 
>- Les installations du service KMS sur Windows 8.1 ou Windows Server 2012 R2 doivent être mis à jour pour prendre en charge l’activation des clients exécutant Windows 10 et Windows Server 2016 ou Windows Server 2019, ou de client plus récente ou de systèmes d’exploitation serveur. Pour plus d’informations, voir[juillet 2016 correctif cumulatif pour Windows 8.1 et Windows Server 2012 R2](https://support.microsoft.com/help/3172614/july-2016-update-rollup-for-windows-8.1-and-windows-server-2012-r2).  
>- Windows Server 2008 R2 ne peut pas être mis à jour pour prendre en charge l’activation des clients qui exécutent Windows Server 2016, Windows Server 2019 ou des systèmes d’exploitation plus récents. 
...
>[!NOTE] 
>Pour demander une telle exception, contactez votre Centre d’activation. Pour plus d’informations, voir la page [Licences en volume Microsoft](https://go.microsoft.com/fwlink/?LinkID=73076).

Les ordinateurs qui exécutent des éditions de licence en volume de Windows 10, Windows Server 2019, Windows Server 2016, Windows 8.1, Windows Server 2012 R2, Windows Server 2012, Windows 7, Windows Server 2008 R2 sont, par défaut, les clients KMS sans aucune configuration supplémentaire nécessaires.

Si vous convertissez un ordinateur depuis un hôte KMS, une clé d’activation multiple (MAK) ou une version commerciale de Windows en un client KMS, installez la clé de configuration de client KMS applicable. Pour plus d’informations, voir les[Clés d’installation du Client KMS](../get-started/KMSclientkeys.md). 

...
## <a name="BKMK_HyperVManager"></a>Créer une machine virtuelle à l’aide du Gestionnaire Hyper-V  
...
4.  Faire les choix appropriés pour votre machine virtuelle sur chacune des pages. Pour plus d’informations, consultez [nouvelles options de machine virtuelle et les valeurs par défaut dans le Gestionnaire Hyper-V](#BKMK_Options) plus loin dans cette rubrique.  
...
## <a name="BKMK_PowerShell"></a>Créer une machine virtuelle à l’aide de Windows PowerShell  
...
## <a name="BKMK_Options"></a>Options de l’Assistant Nouvel ordinateur virtuel de Gestionnaire Hyper-V  
...
- [Versions de configuration de machine virtuelle prises en charge](../deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server.md#BKMK_SupportedConfigVersions)  

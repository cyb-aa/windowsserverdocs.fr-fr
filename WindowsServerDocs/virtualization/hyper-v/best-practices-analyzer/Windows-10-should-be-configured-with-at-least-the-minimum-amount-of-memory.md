---
title: Windows 10 doit être configuré avec au moins la quantité minimale de mémoire
...
ms.locfileid: "59824120"
---
# <a name="windows-10-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows 10 doit être configuré avec au moins la quantité minimale de mémoire
...
Les sections suivantes fournissent des détails sur le problème spécifique. Italique indique le texte de l’interface utilisateur qui apparaît dans l’outil Best Practices Analyzer pour le problème spécifique.  
  
## <a name="issue"></a>**Problème**  
*Une machine virtuelle exécutant Windows 10 est configurée avec inférieure à la quantité minimale de RAM, qui est de 512 Mo.*  

...
*Une machine virtuelle exécutant Windows Server 2008 R2 est configurée avec inférieure à la quantité minimale de RAM, qui est de 512 Mo.*  
...
### <a name="to-increase-the-memory-using-hyper-v"></a>Pour augmenter la mémoire à l’aide de Hyper-V  

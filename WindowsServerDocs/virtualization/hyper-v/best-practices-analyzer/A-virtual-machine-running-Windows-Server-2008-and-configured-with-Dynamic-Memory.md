---
title: Une machine virtuelle exécutant Windows Server 2008 et configurée avec Mémoire dynamique doit utiliser les valeurs recommandées pour les paramètres de mémoire
...
ms.locfileid: "71365338"
---
# <a name="a-virtual-machine-running-windows-server-2008-and-configured-with-dynamic-memory-should-use-recommended-values-for-memory-settings"></a>Une machine virtuelle exécutant Windows Server 2008 et configurée avec Mémoire dynamique doit utiliser les valeurs recommandées pour les paramètres de mémoire
...
*Une ou plusieurs machines virtuelles sont configurées pour utiliser Mémoire dynamique avec une quantité inférieure à la quantité de mémoire recommandée pour Windows Server 2008.*  
...
5.  Sous **mémoire dynamique**, définissez la **RAM minimale** sur au moins 256 Mo et la **ram maximale** sur au moins 512 Mo.  

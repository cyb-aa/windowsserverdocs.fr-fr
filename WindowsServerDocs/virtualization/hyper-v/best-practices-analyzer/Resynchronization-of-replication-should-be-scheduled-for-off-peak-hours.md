...
*The plus un ordinateur virtuel est dans un État nécessitant une resynchronisation, plus les fichiers journaux de réplication augmentent et plus les modifications non répliquées se produisent sur les machines virtuelles principales. Cela a un impact sur les ordinateurs virtuels suivants :*  

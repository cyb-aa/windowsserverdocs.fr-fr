---
title: Windows Server 2016 doivent être configurés avec la quantité de mémoire recommandée
...
ms.locfileid: "59848540"
---
# <a name="windows-server-2016-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Server 2016 doivent être configurés avec la quantité de mémoire recommandée
...
*Une machine virtuelle exécutant Windows Server 2016 est configurée avec inférieure à la quantité de RAM, qui est de 1 Go recommandée.*  
...
3.  Exécutez cette commande après avoir remplacé <MyVM> avec le nom de votre machine virtuelle :  

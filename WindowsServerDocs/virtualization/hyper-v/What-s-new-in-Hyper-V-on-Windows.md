...
ms.locfileid: "59848100"
---
# <a name="whats-new-in-hyper-v-on-windows-server-2016"></a>Quelles sont les nouveautés dans Hyper-V sur Windows Server 2016

>S'applique à : Microsoft Hyper-V Server 2016, Windows Server 2016
  
Cet article décrit les fonctionnalités nouvelles et modifiées de Hyper-V sur Windows Server 2016 et Microsoft Hyper-V Server 2016. Pour utiliser les nouvelles fonctionnalités sur des machines virtuelles créées avec Windows Server 2012 R2 et déplacé ou importé sur un serveur qui exécute Hyper-V sur Windows Server 2016, vous devez manuellement mettre à niveau la version de configuration de machine virtuelle. Pour obtenir des instructions, consultez [version mise à niveau virtual machine](deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server.md).  
  
Voici ce qui est inclus dans cet article et que la fonctionnalité est nouveau ou mis à jour.  

## <a name="BKMK_standby"></a>Compatible avec la veille connectée \(nouveau\)
...
## <a name="BKMK_device"></a>Attribution discrète d’appareils \(nouveau\) 
...
## <a name="BKMK_host"></a>Héberger de protection des ressources \(nouveau\)
...
## <a name="BKMK_hot"></a>Chaud ajouter et supprimer des cartes réseau et mémoire \(nouveau\) 
...
## <a name="BKMK_Mgmt"></a>Améliorations du Gestionnaire Hyper-V \(mis à jour\) 
...
-   **Gérer des versions antérieures** -avec le Gestionnaire des Hyper-V dans Windows Server 2016 et Windows 10, vous pouvez gérer les ordinateurs exécutant Hyper-V sur Windows Server 2012, Windows 8, Windows Server 2012 R2 et Windows 8.1.  
...
## <a name="BKMK_IS"></a>Les services d’intégration fournis via Windows Update \(mis à jour\) 
...
## <a name="BKMK_linux"></a>Démarrage sécurisé de Linux \(nouveau\) 
...
## <a name="BKMK_nested"></a>Virtualisation imbriquée \(nouveau\) 
...
-   Pour exécuter au moins Windows Server 2016 ou Windows 10 sur l’hôte Hyper-V physique et l’hôte virtualisé.  
...
## <a name="BKMK_networking"></a>Fonctionnalités de mise en réseau \(nouveau\) 
...
## <a name="BKMK_check"></a>Points de contrôle de production \(nouveau\)
...
## <a name="BKMK_shared"></a>Des disques dur virtuels partagés \(mis à jour\)
...
## <a name="BKMK_shielded"></a>Des machines virtuelles protégées \(nouveau\)
...
## <a name="BKMK_StartOrder"></a>Démarrer la priorité de commande pour les ordinateurs virtuels en cluster \(nouveau\)
...
.  
## <a name="BKMK_QoS"></a>Qualité de service (QoS) de stockage \(mis à jour\)
...
## <a name="BKMK_Config"></a>Format de fichier de configuration de machine virtuelle \(mis à jour\)
...
## <a name="BKMK_Containers"></a>Les conteneurs Windows \(nouveau\) 
...
## <a name="BKMK_PowerShellDirect"></a>Windows PowerShell Direct \(nouveau\)  

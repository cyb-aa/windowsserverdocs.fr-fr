...
- [FZI Research Center pour les technologies de l’Information](#fzi-research-center-for-information-technology)
- [Groupe de GVC](#gvc-group)
- [Technologies à l’intérieur](#inside-technologies)
...
### <a name="the-challenge"></a>**Le défi**
...
Windows Admin Center a permis à Comparex de gagner du temps dans ses activités quotidiennes, d'accroître sa productif et son efficacité.  Windows Admin Center a également permis de résoudre des problèmes de gestion courants avec ses clients, par exemple, avec Hyper-V et les espaces de stockage direct.
...
Convergent Computing utilise Windows Server 2016 (Nano, Core, Datacenter, Standard, Hyper-V) et Windows Server 2012 R2 (Server Core, Datacenter, Standard et Hyper-V).
...
Windows Admin Center permet à FZI d'accélérer le rythme auquel il peut effectuer certaines tâches, telles que les mises à jour Windows mensuelles, en se connectant à des serveurs via le Bureau à distance et en apportant des modifications administratives mineures rapidement.
...
Windows Admin Center est déployé par Inside Technologies sur un serveur unique afin de gérer toutes les ressources dans son environnement.
...
VaiSulWeb effectuent ses déploiements dans un large éventail de scénarios, notamment le clustering de basculement et les configurations hyperconvergées.  Windows Admin Center est déployé sur des stations de travail Windows 10 et des serveurs Windows pour gérer ses ressources.

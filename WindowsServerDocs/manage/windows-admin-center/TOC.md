...
## Utiliser
### [Commencer](use/get-started.md)
### [Gérer les serveurs](use/manage-servers.md)
### [Gérer l’infrastructure hyperconvergée](use/manage-hyper-converged.md)
### [Gérer des clusters de basculement](use/manage-failover-clusters.md)
### [Gérer des ordinateurs virtuels Hyper-V](use/manage-virtual-machines.md)
### [Journalisation](use/logging.md)


## Se connecter à Azure
### [Services Azure hybride](azure/index.md)
#### [Sauvegarde Azure](azure/azure-backup.md)
#### [Azure Site Recovery](azure/azure-site-recovery.md)
#### [Synchronisation de fichier Azure](azure/azure-file-sync.md)
#### [Moniteur Azure](azure/azure-monitor.md)
#### [Gestion des mises à jour Azure](azure/azure-update-management.md)
### [Se connecter Windows Admin Center à Azure](azure/azure-integration.md)
...
## Support
### [Politique de support](support/index.md)
...
#### [Guide des icônes CSS](extend/guides/cssicons.md)
#### [Migrer vers la dernière version du SDK](extend/guides/migration-guide-0_1-1_0.md)
#### [Activer la bannière de la découverte d’extension](extend/guides/extension-discovery-banner.md)

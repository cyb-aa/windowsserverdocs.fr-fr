...
### <a name="DDI"></a>DNS intégré, DHCP et gestion des adresses IP (DDI)  
...
### <a name="bkmk_ps"></a>Prise en charge de Windows PowerShell pour les Access Control basés sur les rôles  

...
>[!NOTE]
>Pour la référence de commande IPAM Windows PowerShell, consultez [l’applets de commande du serveur de gestion des adresses IP (IPAM) dans Windows PowerShell](https://technet.microsoft.com/library/jj553807.aspx).  
...
Pour plus d’informations, consultez [Find-IpamFreeSubnet](https://technet.microsoft.com/library/mt712782.aspx).  
...
Pour plus d’informations, consultez [Find-IpamFreeRange](https://technet.microsoft.com/library/mt712772.aspx).  

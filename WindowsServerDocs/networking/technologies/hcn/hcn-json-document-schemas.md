---
title: Schémas de document JSON de réseau de calcul (HCN) hôte
description: ''
ms.author: jmesser
author: jmesser81
ms.date: 11/05/2018
...
## <a name="hcn-endpoint-schema"></a>Schéma de point de terminaison HCN
...
## <a name="hcn-policy-schema"></a>Schéma de stratégie HCN
...
## <a name="hcn-load-balancer-schema"></a>Schéma d’équilibrage de charge HCN
...
## <a name="hcn-namespace-schema"></a>Schéma d’espace de noms HCN
...
## <a name="hcn-notification-schema"></a>Schéma de notification HCN
...
## <a name="result-error-schema"></a>Schéma d’erreur de résultat

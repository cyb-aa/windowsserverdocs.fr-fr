...
**Pour remplacer <em>user@example.microsoft.com</em> avec *example.microsoft.com\user***
...
<strong>Pour remplacer *utilisateur* avec *user@specific_domain</strong>*

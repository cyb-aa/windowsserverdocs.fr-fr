...
1.  [Copier des données vers le serveur de Destination](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_CopyData)  
...
5.  [Supprimer des objets de stratégie de groupe Active Directory hérités (facultatifs)](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_RemoveLegacyADGPO)  
  
6.  [Mapper les ordinateurs autorisés aux comptes d’utilisateurs](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_MapPermittedComputers)  
...
##  <a name="BKMK_RemoveLegacyADGPO"></a> Supprimer des objets de stratégie de groupe Active Directory hérités (facultatifs)  

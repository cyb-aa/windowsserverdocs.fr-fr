...
###  <a name="BKMK_DeleteSvcAcctSetting"></a>Supprimer le paramètre ouvrir une session en tant que compte de service  
...
###  <a name="BKMK_MigrateLOB"></a>Créer un plan pour migrer des applications métier  
